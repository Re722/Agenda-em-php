...
function getFormularioInclusao() {
 ...
 form += '</div>'; 
form += '<div class="form-group">'; 
 form += '<label for="site" class="col-sm-2 control-label glyphicon glyphicon-home"></label>';
 form += '<div class="col-sm-8">'; 
 form += '<textarea class="form-control" rows="3" id="site" placeholder="Site"></textarea>'; 
 form += '</div>'; 
 form += '</div>'; 
 form += '<div class="form-group">'; 
...
function salvarContato() { 
 ...
 Contato.site = $('textarea#site').val(); 
...
jsonDado, 
 ...
 form += '<label for="endereco" class="col-sm-2 control-label glyphicon glyphicon-home"></label>'; 
 form += '<div class="col-sm-8">'; 
 form += '<textarea class="form-control" rows="2" id="endereco" placeholder="Endereço">' 
 ...
 form += '<label for="site" class="col-sm-2 control-label glyphicon glyphicon-home"></label>'; 
 form += '<div class="col-sm-8">'; 
 form += '<textarea class="form-control" rows="2" id="site" placeholder="Site">' 
